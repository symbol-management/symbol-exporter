...
def test_package_name():
    ...
    assert z.symbols == {
        "__init__": {"type": SymbolType.PACKAGE, "data": {},},
        "__init__.xyz": {"type": SymbolType.IMPORT, "data": {"shadows": "abc.xyz"},},
    }
...
def test_fully_qualified_package_names():
    ...
    assert z.symbols == {
        "mm.__init__": {"type": SymbolType.PACKAGE, "data": {},},
        "mm.__init__.xyz": {"type": SymbolType.IMPORT, "data": {"shadows": "abc.xyz"},},
    }
...
def test_fully_qualified_module_names():
    ...
    assert z.symbols == {
        "mm.core": {"type": SymbolType.MODULE, "data": {},},
        "mm.core.xyz": {"type": SymbolType.IMPORT, "data": {"shadows": "abc.xyz"},},
    }
...
def test_from_import_attr_access():
    ...
    assert z.symbols == {
        "mm": {"type": SymbolType.MODULE, "data": {},},
        "mm.xyz": {"type": SymbolType.IMPORT, "data": {"shadows": "abc.xyz"},},
        "mm.f": {
...
def test_alias_import():
    ...
    assert z.symbols == {
        "mm": {"type": SymbolType.MODULE, "data": {},},
        "mm.l": {"type": SymbolType.IMPORT, "data": {"shadows": "abc.xyz"},},
        "mm.f": {
            "type": SymbolType.FUNCTION,
            "data": {"lineno": 4, "symbols_in_volume": {"abc.xyz.i": {"line number": [5]}},},
        },
...
def test_calls():
    ...
    assert z.symbols == {
        ...
        "mm.f": {
            ...
            "data": {
                "lineno": 4,
                "symbols_in_volume": {"numpy.ones": {"line number": [5]}, "numpy.twos": {"line number": [5]},},
            },
        },
        "mm.np": {"type": SymbolType.IMPORT, "data": {"shadows": "numpy"},},
    }
...
def test_constant():
    ...
    assert z.symbols == {
        "mm": {"type": SymbolType.MODULE, "data": {"symbols_in_volume": {"numpy.ones": {"line number": [4]}}},},
        "mm.np": {"type": SymbolType.IMPORT, "data": {"shadows": "numpy"},},
        "mm.z": {"type": SymbolType.CONSTANT, "data": {"lineno": 4},},
    }
...
def test_class_method():
    ...
    assert z.symbols == {
        ...
        "mm.ABC.xyz": {
            "type": SymbolType.FUNCTION,
            "data": {"lineno": 7, "symbols_in_volume": {"numpy.twos": {"line number": [8]}},},
        },
        "mm.np": {"type": SymbolType.IMPORT, "data": {"shadows": "numpy"},},
    }
...
def test_import_adds_symbols():
    ...
    assert z.symbols == {
        "mm.np": {"type": SymbolType.IMPORT, "data": {"shadows": "numpy"},},
        "mm.l": {"type": SymbolType.IMPORT, "data": {"shadows": "abc.xyz"},},
        "mm.efg": {"type": SymbolType.IMPORT, "data": {"shadows": "ggg.efg"},},
        "mm.ghi": {"type": SymbolType.IMPORT, "data": {"shadows": "ghi"},},
        "mm": {"type": SymbolType.MODULE, "data": {"symbols_in_volume": {"numpy.ones": {"line number": [7]}}},},
        "mm.z": {"type": SymbolType.CONSTANT, "data": {"lineno": 7},},
    }
...
def test_star_import():
    ...
    assert z.symbols == {
        "mm.*": {"type": SymbolType.STAR_IMPORT, "data": {"imports": {"abc"}},},
        "mm.np": {"type": SymbolType.IMPORT, "data": {"shadows": "numpy"},},
        "mm": {"type": SymbolType.MODULE, "data": {},},
    }
...
def test_relative_import():
    ...
    z = process_code_str(code)
    assert z.symbols == {
        "mm.core": {"type": SymbolType.RELATIVE_IMPORT, "data": {"shadows": "core", "level": 1, "module": "mm"},},
        "mm.ones": {"type": SymbolType.RELATIVE_IMPORT, "data": {"shadows": "core.ones", "level": 1, "module": "mm"},},
        "mm.twos": {"type": SymbolType.RELATIVE_IMPORT, "data": {"shadows": "core.twos", "level": 2, "module": "mm"},},
        "mm": {"type": SymbolType.MODULE, "data": {},},
    }
...
def test_relative_alias_import():
    ...
    assert z.symbols == {
        ...
        "mm.c": {"type": SymbolType.RELATIVE_IMPORT, "data": {"shadows": "core", "level": 1, "module": "mm"},},
        "mm.c_ones": {
...
def test_relative_star_import():
    ...
    assert z.symbols == {
        ...
        "mm.~~RELATIVE~~.*": {
            ...
            "data": {
                "imports": [
                    {"shadows": "core", "level": 1, "module": "mm",},
                    {"shadows": "numeric", "level": 2, "module": "mm",},
                ]
            },
        },
    }
...
def test_undeclared_symbols():
    ...
    assert z.symbols == {
        "mm.*": {"type": SymbolType.STAR_IMPORT, "data": {"imports": {"abc", "xyz"}},},
        "mm": {
            "type": SymbolType.MODULE,
            "data": {"symbols_in_volume": {"numpy.ones": {"line number": [8]}, "twos": {"line number": [9]},},},
        },
        "mm.a": {"type": SymbolType.CONSTANT, "data": {"lineno": 8},},
        "mm.b": {"type": SymbolType.CONSTANT, "data": {"lineno": 9},},
        "mm.np": {"type": SymbolType.IMPORT, "data": {"shadows": "numpy"},},
    }
...
def test_imported_symbols_not_treated_as_undeclared():
    ...
    assert z.symbols == {
        "mm": {"type": SymbolType.MODULE, "data": {"symbols_in_volume": {"abc.twos": {"line number": [4]}}},},
        "mm.twos": {"type": SymbolType.IMPORT, "data": {"shadows": "abc.twos"},},
        "mm.b": {"type": SymbolType.CONSTANT, "data": {"lineno": 4},},
    }
...
def test_builtin_symbols_not_treated_as_undeclared():
    ...
    assert z.symbols == {
        "mm": {"type": SymbolType.MODULE, "data": {"symbols_in_volume": {"len": {"line number": [4]}}},},
        "mm.twos": {"type": SymbolType.IMPORT, "data": {"shadows": "abc.twos"},},
        "mm.b": {"type": SymbolType.CONSTANT, "data": {"lineno": 4},},
    }
    assert not z.undeclared_symbols
...
def test_functions_not_treated_as_undeclared():
    ...
    assert z.symbols == {
        "mm": {"type": SymbolType.MODULE, "data": {"symbols_in_volume": {"mm.f": {"line number": [7]}}},},
        "mm.f": {"type": SymbolType.FUNCTION, "data": {"lineno": 4},},
        "mm.twos": {"type": SymbolType.IMPORT, "data": {"shadows": "abc.twos"},},
        "mm.g": {"type": SymbolType.CONSTANT, "data": {"lineno": 7},},
    }
    assert not z.undeclared_symbols
...
def test_attr_assignment():
    ...
    assert z.symbols == {
        "mm": {
            "data": {
                "symbols_in_volume": {"abc.twos.three": {"line number": [4]}, "abc.twos.four": {"line number": [5]},}
            },
            "type": SymbolType.MODULE,
        },
...
def test_multi_use_of_symbol():
    ...
    assert z.post_process_symbols() == {
        "mm": {"data": {}, "type": SymbolType.MODULE},
        "mm.a": {
            "data": {"lineno": 2, "symbols_in_volume": {"ones": {"line number": [3, 4]}},},
            "type": SymbolType.FUNCTION,
        },
    }
...
def test_symbols_in_volume_names():
    ...
    assert z.post_process_symbols() == {
        "mm": {
            "data": {"symbols_in_volume": {"ast.Try": {"line number": [4]}, "mm.z": {"line number": [5]},}},
            "type": SymbolType.MODULE,
        },
