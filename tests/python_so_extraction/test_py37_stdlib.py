...
def test__sha1():
    ...
    compare("lib/python3.7/lib-dynload/_sha1.cpython-37m-x86_64-linux-gnu.so", "_sha1", expected)


def test__sha256():
    expected = {'SHA224Type', 'SHA256Type', 'sha224', 'sha256'}
    compare("lib/python3.7/lib-dynload/_sha256.cpython-37m-x86_64-linux-gnu.so", "_sha256", expected)


def test__sha3():
    expected = {'implementation', 'keccakopt', 'sha3_224', 'sha3_256', 'sha3_384', 'sha3_512', 'shake_128', 'shake_256'}
    compare("lib/python3.7/lib-dynload/_sha3.cpython-37m-x86_64-linux-gnu.so", "_sha3", expected)


def test__sha512():
    expected = {'SHA384Type', 'SHA512Type', 'sha384', 'sha512'}
    compare("lib/python3.7/lib-dynload/_sha512.cpython-37m-x86_64-linux-gnu.so", "_sha512", expected)
...
def test_zlib():
    ...
    compare("lib/python3.7/lib-dynload/zlib.cpython-37m-x86_64-linux-gnu.so", "zlib", expected)
...
def test_math():
    ...
    compare("lib/python3.7/lib-dynload/math.cpython-37m-x86_64-linux-gnu.so", "math", expected)
...
def test_mmap():
    ...
    compare("lib/python3.7/lib-dynload/mmap.cpython-37m-x86_64-linux-gnu.so", "mmap", expected)


def test__md5():
    expected = {'MD5Type', 'md5'}
    compare("lib/python3.7/lib-dynload/_md5.cpython-37m-x86_64-linux-gnu.so", "_md5", expected)


def test__json():
    expected = {'encode_basestring', 'encode_basestring_ascii', 'make_encoder', 'make_scanner', 'scanstring'}
    compare("lib/python3.7/lib-dynload/_json.cpython-37m-x86_64-linux-gnu.so", "_json", expected)


def test__bz2():
    expected = {'BZ2Compressor', 'BZ2Decompressor'}
    compare("lib/python3.7/lib-dynload/_bz2.cpython-37m-x86_64-linux-gnu.so", "_bz2", expected)
...
def test__curses_py37():
    ...
    compare('lib/python3.7/lib-dynload/_curses.cpython-37m-x86_64-linux-gnu.so', '_curses', expected, xmissing=True)
...
def test__csv_py37():
    ...
    compare('lib/python3.7/lib-dynload/_csv.cpython-37m-x86_64-linux-gnu.so', '_csv', expected, xmissing=True)
...
def test_binascii():
    ...
    compare("lib/python3.7/lib-dynload/binascii.cpython-37m-x86_64-linux-gnu.so", "binascii", expected)
...
def test_ctypes():
    ...
    compare('lib/python3.7/lib-dynload/_ctypes.cpython-37m-x86_64-linux-gnu.so', '_ctypes', expected, xmissing=True)
...
def test_cmath():
    ...
    compare('lib/python3.7/lib-dynload/cmath.cpython-37m-x86_64-linux-gnu.so', 'cmath', expected)
...
def test_blake2():
    ...
    compare('lib/python3.7/lib-dynload/_blake2.cpython-37m-x86_64-linux-gnu.so', '_blake2', expected)


def test_nis():
    expected = {'maps', 'get_default_domain', 'match', 'error', 'cat'}
    compare('lib/python3.7/lib-dynload/nis.cpython-37m-x86_64-linux-gnu.so', 'nis', expected)
...
def test_parser():
    ...
    compare('lib/python3.7/lib-dynload/parser.cpython-37m-x86_64-linux-gnu.so', 'parser', expected)


def test_pickle():
    expected = {'PickleError', 'Pickler', 'dump', 'UnpicklingError', 'PicklingError', 'loads', 'load', 'Unpickler', 'dumps'}
    compare('lib/python3.7/lib-dynload/_pickle.cpython-37m-x86_64-linux-gnu.so', '_pickle', expected)
...
def test_pyexpat():
    ...
    compare('lib/python3.7/lib-dynload/pyexpat.cpython-37m-x86_64-linux-gnu.so', 'pyexpat', expected)


def test_random():
    expected = {'Random'}
    compare('lib/python3.7/lib-dynload/_random.cpython-37m-x86_64-linux-gnu.so', '_random', expected)
...
def test_select():
    ...
    compare('lib/python3.7/lib-dynload/select.cpython-37m-x86_64-linux-gnu.so', 'select', expected)
...
def test_asyncio():
    ...
    compare('lib/python3.7/lib-dynload/_asyncio.cpython-37m-x86_64-linux-gnu.so', '_asyncio', expected)


def test_bisect():
    expected = {'bisect_right', 'insort_left', 'insort_right', 'bisect_left'}
    compare('lib/python3.7/lib-dynload/_bisect.cpython-37m-x86_64-linux-gnu.so', '_bisect', expected)
...
def test__codecs_cn():
    ...
    compare('lib/python3.7/lib-dynload/_codecs_cn.cpython-37m-x86_64-linux-gnu.so', '_codecs_cn', expected, xmissing=True)


@pytest.mark.xfail(reason="The object names are generated dynamically using strcp, better emulation is required to handle this.")
def test__codecs_hk():
    expected = {'__map_big5hkscs_nonbmp', '__map_big5hkscs_bmp', 'getcodec', '__map_big5hkscs'}
    compare('lib/python3.7/lib-dynload/_codecs_hk.cpython-37m-x86_64-linux-gnu.so', '_codecs_hk', expected, xmissing=True)


def test__codecs_iso2022():
    expected = {'getcodec'}
    compare('lib/python3.7/lib-dynload/_codecs_iso2022.cpython-37m-x86_64-linux-gnu.so', '_codecs_iso2022', expected)
...
def test__codecs_jp():
    ...
    compare('lib/python3.7/lib-dynload/_codecs_jp.cpython-37m-x86_64-linux-gnu.so', '_codecs_jp', expected, xmissing=True)


@pytest.mark.xfail(reason="The object names are generated dynamically using strcp, better emulation is required to handle this.")
def test__codecs_kr():
    expected = {'__map_ksx1001', '__map_cp949ext', '__map_cp949', 'getcodec'}
    compare('lib/python3.7/lib-dynload/_codecs_kr.cpython-37m-x86_64-linux-gnu.so', '_codecs_kr', expected, xmissing=True)


@pytest.mark.xfail(reason="The object names are generated dynamically using strcp, better emulation is required to handle this.")
def test__codecs_tw():
    expected = {'getcodec', '__map_cp950ext', '__map_big5'}
    compare('lib/python3.7/lib-dynload/_codecs_tw.cpython-37m-x86_64-linux-gnu.so', '_codecs_tw', expected, xmissing=True)


def test_contextvars():
    expected = {'copy_context', 'ContextVar', 'Token', 'Context'}
    compare('lib/python3.7/lib-dynload/_contextvars.cpython-37m-x86_64-linux-gnu.so', '_contextvars', expected)


def test_crypt():
    expected = {'crypt'}
    compare('lib/python3.7/lib-dynload/_crypt.cpython-37m-x86_64-linux-gnu.so', '_crypt', expected)


def test_ctypes_test():
    expected = {'func', 'func_si'}
    compare('lib/python3.7/lib-dynload/_ctypes_test.cpython-37m-x86_64-linux-gnu.so', '_ctypes_test', expected)


def test_curses_panel():
    expected = {'new_panel', 'top_panel', 'error', 'version', 'update_panels', 'bottom_panel'}
    compare('lib/python3.7/lib-dynload/_curses_panel.cpython-37m-x86_64-linux-gnu.so', '_curses_panel', expected, xmissing=True)


def test_datetime():
    expected = {'MINYEAR', 'timezone', 'MAXYEAR', 'timedelta', 'datetime', 'tzinfo', 'time', 'date', 'datetime_CAPI'}
    compare('lib/python3.7/lib-dynload/_datetime.cpython-37m-x86_64-linux-gnu.so', '_datetime', expected)
...
def test_decimal():
    ...
    compare('lib/python3.7/lib-dynload/_decimal.cpython-37m-x86_64-linux-gnu.so', '_decimal', expected, xmissing=True)


def test_elementtree():
    expected = {'TreeBuilder', 'XMLParser', 'SubElement', 'Element', 'ParseError'}
    compare('lib/python3.7/lib-dynload/_elementtree.cpython-37m-x86_64-linux-gnu.so', '_elementtree', expected)
...
def test_hashlib():
    ...
    compare('lib/python3.7/lib-dynload/_hashlib.cpython-37m-x86_64-linux-gnu.so', '_hashlib', expected)


def test_heapq():
    expected = {'__about__', 'heapreplace', '_heapreplace_max', '_heapify_max', 'heappop', '_heappop_max', 'heappush', 'heapify', 'heappushpop'}
    compare('lib/python3.7/lib-dynload/_heapq.cpython-37m-x86_64-linux-gnu.so', '_heapq', expected)


def test_lsprof():
    expected = {'profiler_entry', 'Profiler', 'profiler_subentry'}
    compare('lib/python3.7/lib-dynload/_lsprof.cpython-37m-x86_64-linux-gnu.so', '_lsprof', expected)
...
def test_lzma():
    ...
    compare('lib/python3.7/lib-dynload/_lzma.cpython-37m-x86_64-linux-gnu.so', '_lzma', expected)
...
def test_multibytecodec():
    ...
    compare('lib/python3.7/lib-dynload/_multibytecodec.cpython-37m-x86_64-linux-gnu.so', '_multibytecodec', expected, xmissing=True)


def test_multiprocessing():
    expected = {'flags', 'sem_unlink', 'SemLock'}
    compare('lib/python3.7/lib-dynload/_multiprocessing.cpython-37m-x86_64-linux-gnu.so', '_multiprocessing', expected)


def test_opcode():
    expected = {'stack_effect'}
    compare('lib/python3.7/lib-dynload/_opcode.cpython-37m-x86_64-linux-gnu.so', '_opcode', expected)


def test_posixsubprocess():
    expected = {'fork_exec'}
    compare('lib/python3.7/lib-dynload/_posixsubprocess.cpython-37m-x86_64-linux-gnu.so', '_posixsubprocess', expected)


def test_queue():
    expected = {'Empty', 'SimpleQueue'}
    compare('lib/python3.7/lib-dynload/_queue.cpython-37m-x86_64-linux-gnu.so', '_queue', expected)
...
def test_socket():
    ...
    compare('lib/python3.7/lib-dynload/_socket.cpython-37m-x86_64-linux-gnu.so', '_socket', expected)
...
def test_sqlite3():
    ...
    compare('lib/python3.7/lib-dynload/_sqlite3.cpython-37m-x86_64-linux-gnu.so', '_sqlite3', expected, xmissing=True)
...
def test_ssl():
    ...
    compare('lib/python3.7/lib-dynload/_ssl.cpython-37m-x86_64-linux-gnu.so', '_ssl', expected)


def test_struct():
    expected = {'pack_into', 'calcsize', 'Struct', 'iter_unpack', '_clearcache', 'unpack', 'pack', 'unpack_from', 'error'}
    compare('lib/python3.7/lib-dynload/_struct.cpython-37m-x86_64-linux-gnu.so', '_struct', expected)
...
def test_testbuffer():
    ...
    compare('lib/python3.7/lib-dynload/_testbuffer.cpython-37m-x86_64-linux-gnu.so', '_testbuffer', expected)
...
def test_testcapi():
    ...
    compare('lib/python3.7/lib-dynload/_testcapi.cpython-37m-x86_64-linux-gnu.so', '_testcapi', expected)


def test_testimportmultiple():
    expected = set()
    compare('lib/python3.7/lib-dynload/_testimportmultiple.cpython-37m-x86_64-linux-gnu.so', '_testimportmultiple', expected)


def test_testmultiphase():
    expected = {'call_state_registration_func', 'Str', 'Example', 'int_const', 'str_const', 'foo', 'error'}
    compare('lib/python3.7/lib-dynload/_testmultiphase.cpython-37m-x86_64-linux-gnu.so', '_testmultiphase', expected, xmissing=True)
...
def test_tkinter():
    ...
    compare('lib/python3.7/lib-dynload/_tkinter.cpython-37m-x86_64-linux-gnu.so', '_tkinter', expected)


def test_xxtestfuzz():
    expected = {'run'}
    compare('lib/python3.7/lib-dynload/_xxtestfuzz.cpython-37m-x86_64-linux-gnu.so', '_xxtestfuzz', expected)


def test_array():
    expected = {'typecodes', 'ArrayType', '_array_reconstructor', 'array'}
    compare('lib/python3.7/lib-dynload/array.cpython-37m-x86_64-linux-gnu.so', 'array', expected, xmissing=True)
...
def test_audioop():
    ...
    compare('lib/python3.7/lib-dynload/audioop.cpython-37m-x86_64-linux-gnu.so', 'audioop', expected)
...
def test_fcntl():
    ...
    compare('lib/python3.7/lib-dynload/fcntl.cpython-37m-x86_64-linux-gnu.so', 'fcntl', expected)


def test_grp():
    expected = {'struct_group', 'getgrall', 'getgrnam', 'getgrgid'}
    compare('lib/python3.7/lib-dynload/grp.cpython-37m-x86_64-linux-gnu.so', 'grp', expected)
...
def test_ossaudiodev():
    ...
    compare('lib/python3.7/lib-dynload/ossaudiodev.cpython-37m-x86_64-linux-gnu.so', 'ossaudiodev', expected)
...
def test_readline():
    ...
    compare('lib/python3.7/lib-dynload/readline.cpython-37m-x86_64-linux-gnu.so', 'readline', expected)
...
def test_resource():
    ...
    compare('lib/python3.7/lib-dynload/resource.cpython-37m-x86_64-linux-gnu.so', 'resource', expected)


def test_spwd():
    expected = {'getspall', 'getspnam', 'struct_spwd'}
    compare('lib/python3.7/lib-dynload/spwd.cpython-37m-x86_64-linux-gnu.so', 'spwd', expected)
...
def test_syslog():
    ...
    compare('lib/python3.7/lib-dynload/syslog.cpython-37m-x86_64-linux-gnu.so', 'syslog', expected)
...
def test_termios():
    ...
    compare('lib/python3.7/lib-dynload/termios.cpython-37m-x86_64-linux-gnu.so', 'termios', expected, xmissing=True)
...
def test_unicodedata():
    ...
    compare('lib/python3.7/lib-dynload/unicodedata.cpython-37m-x86_64-linux-gnu.so', 'unicodedata', expected)


def test_xxlimited():
    expected = {'Xxo', 'Null', 'Str', 'roj', 'new', 'error', 'foo'}
    compare('lib/python3.7/lib-dynload/xxlimited.cpython-37m-x86_64-linux-gnu.so', 'xxlimited', expected, xmissing=True)
