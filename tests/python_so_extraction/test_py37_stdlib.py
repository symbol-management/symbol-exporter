...
def test__curses_py37():
    ...
    compare("lib/python3.7/lib-dynload/_curses.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)
...
def test__csv_py37():
    ...
    compare("lib/python3.7/lib-dynload/_csv.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)
...
def test_ctypes():
    ...
    compare("lib/python3.7/lib-dynload/_ctypes.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)
...
def test__codecs_cn():
    ...
    compare("lib/python3.7/lib-dynload/_codecs_cn.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)


@pytest.mark.xfail(reason="The object names are generated dynamically using strcp, better emulation is required to handle this.")
def test__codecs_hk():
    expected = {"__map_big5hkscs_nonbmp", "__map_big5hkscs_bmp", "getcodec", "__map_big5hkscs"}
    compare("lib/python3.7/lib-dynload/_codecs_hk.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)


def test__codecs_iso2022():
    expected = {"getcodec"}
    compare("lib/python3.7/lib-dynload/_codecs_iso2022.cpython-37m-x86_64-linux-gnu.so", expected)
...
def test__codecs_jp():
    ...
    compare("lib/python3.7/lib-dynload/_codecs_jp.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)


@pytest.mark.xfail(reason="The object names are generated dynamically using strcp, better emulation is required to handle this.")
def test__codecs_kr():
    expected = {"__map_ksx1001", "__map_cp949ext", "__map_cp949", "getcodec"}
    compare("lib/python3.7/lib-dynload/_codecs_kr.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)


@pytest.mark.xfail(reason="The object names are generated dynamically using strcp, better emulation is required to handle this.")
def test__codecs_tw():
    expected = {"getcodec", "__map_cp950ext", "__map_big5"}
    compare("lib/python3.7/lib-dynload/_codecs_tw.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)


def test_contextvars():
    expected = {"copy_context", "ContextVar", "Token", "Context"}
    compare("lib/python3.7/lib-dynload/_contextvars.cpython-37m-x86_64-linux-gnu.so", expected)
...
def test_ctypes_test():
    ...
    compare("lib/python3.7/lib-dynload/_ctypes_test.cpython-37m-x86_64-linux-gnu.so", expected)


def test_curses_panel():
    expected = {"new_panel", "top_panel", "error", "version", "update_panels", "bottom_panel"}
    compare("lib/python3.7/lib-dynload/_curses_panel.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)
...
def test_decimal():
    ...
    compare("lib/python3.7/lib-dynload/_decimal.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)


def test_elementtree():
    expected = {"TreeBuilder", "XMLParser", "SubElement", "Element", "ParseError"}
    compare("lib/python3.7/lib-dynload/_elementtree.cpython-37m-x86_64-linux-gnu.so", expected)
...
def test_multibytecodec():
    ...
    compare("lib/python3.7/lib-dynload/_multibytecodec.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)


def test_multiprocessing():
    expected = {"flags", "sem_unlink", "SemLock"}
    compare("lib/python3.7/lib-dynload/_multiprocessing.cpython-37m-x86_64-linux-gnu.so", expected)
...
def test_posixsubprocess():
    expected = {"fork_exec"}
    compare("lib/python3.7/lib-dynload/_posixsubprocess.cpython-37m-x86_64-linux-gnu.so", expected)
...
def test_sqlite3():
    ...
    compare("lib/python3.7/lib-dynload/_sqlite3.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)
...
def test_testbuffer():
    ...
    compare("lib/python3.7/lib-dynload/_testbuffer.cpython-37m-x86_64-linux-gnu.so", expected)
...
def test_testimportmultiple():
    expected = set()
    compare("lib/python3.7/lib-dynload/_testimportmultiple.cpython-37m-x86_64-linux-gnu.so", expected)


def test_testmultiphase():
    expected = {"call_state_registration_func", "Str", "Example", "int_const", "str_const", "foo", "error"}
    compare("lib/python3.7/lib-dynload/_testmultiphase.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)
...
def test_xxtestfuzz():
    expected = {"run"}
    compare("lib/python3.7/lib-dynload/_xxtestfuzz.cpython-37m-x86_64-linux-gnu.so", expected)


def test_array():
    expected = {"typecodes", "ArrayType", "_array_reconstructor", "array"}
    compare("lib/python3.7/lib-dynload/array.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)
...
def test_ossaudiodev():
    ...
    compare("lib/python3.7/lib-dynload/ossaudiodev.cpython-37m-x86_64-linux-gnu.so", expected)
...
def test_termios():
    ...
    compare("lib/python3.7/lib-dynload/termios.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)
...
def test_unicodedata():
    ...
    compare("lib/python3.7/lib-dynload/unicodedata.cpython-37m-x86_64-linux-gnu.so", expected)


def test_xxlimited():
    expected = {"Xxo", "Null", "Str", "roj", "new", "error", "foo"}
    compare("lib/python3.7/lib-dynload/xxlimited.cpython-37m-x86_64-linux-gnu.so", expected, xmissing=True)
