...
def test_find_supplying_version_set():
    ...
    intersection = find_supplying_version_set(volume, get_symbol_table_func=lambda x: SAMPLE_TABLE)
    assert intersection == {'academic-0.5.1-py_0',
 'academic-0.6.1-py_0',
 'academic-0.6.2-py_0',
 'academic-0.7.0-py_0'}
...
def test_find_supplying_version_null_set():
    volume = {'academic.cli', 'academic.cli.AcademicError', 'academic.cli.clean_bibtex_authors'}
