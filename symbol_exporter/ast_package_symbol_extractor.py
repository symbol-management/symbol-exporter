    ...
    for k, v in star_imports:
        ...
        for rel_import in imports:
            ...
            for symbol in package_symbols:
                ...
                if symbol.startswith(shadows) and package_symbols[symbol]["type"] not in {SymbolType.PACKAGE,
                                                                                          SymbolType.MODULE,
                    ...
                    if is_relative_import(package_symbols[symbol]):
                        ...
                        if new_symbol != dereferenced_shadows:
                            ...
                            print(f"found circular reference: {new_symbol} is already in volume of {rel_import['module']},"
                                  f" it is also exposed through import {shadows}.*")
                    else:
